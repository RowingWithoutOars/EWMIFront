    ...
    <div>
        ...
        <el-row style="margin-top: 20px;">
            <el-col :span="14" :offset="4">
                <header class="form_header">删除数据 </header>
                <el-form :model="dataForm" ref="dataForm" label-width="110px" class="form data _form">
                    ...
                    <el-form-item>
                        <el-button type="primary" @click="deleteData('dataForm')">确认删除</el-button>
                    </el-form-item>
                </el-form>
            </el-col>
        </el-row>
            ...
            deleteData(dataForm){
                this.$refs[dataForm].validate(async (valid) => {
                    if (valid) {
                        ...
                        try{
                            const result = await delData(params);
                            if (result.status == 1) {
                                console.log(result)
                                this.$message({
                                    type: 'success',
